//package first.HomeWork3;// Homework 3. Class first.HomeWork3.Laptop, class first.HomeWork3.User, class Application, sorting of laptops.
//
//import java.io.*;
//import java.util.*;
//import java.lang.*;
...
//            }
//            System.out.println(laps[i].getSize() + "\t" + laps[i].getPrice() + "\t" + user.getName() + "\t" + user.getLastName());
//        }
